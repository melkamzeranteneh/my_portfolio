    ...
    <div className="grid gap-6 sm:grid-cols-2">
      {posts.map((post, index) => (
        <motion.article
          ...
          className={`game-panel group p-6 border border-white/5 rounded-sm flex flex-col ${
        ...
        >
          ...
          <div className="mt-6 border-t border-white/5 pt-4">
            <Link
              ...
              className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-accent hover:underline transition"
            >
              Access Log →
            </Link>
          </div>
